  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Modern-Fantasy Skin Tokens (canonical names from §9)  
        bg: "var(--bg)",                      // app chrome (header/sidebar)
        panel: "var(--panel)",                // parchment cards  
        ink: "var(--ink)",                    // primary text on parchment
        muted: "var(--muted)",                // secondary text
        accent: "var(--accent)",              // arcane blue (focus, charts)
        gold: "var(--gold)",                  // dividers/highlights
        emerald: "var(--emerald)",            // success
        border: "var(--border)",              // etched borders
        danger: "var(--danger)",              // danger/error
      },
      borderRadius: {
        lg: "var(--radius)",
        md: "calc(var(--radius) - 2px)",
        sm: "calc(var(--radius) - 4px)",
        xl: "var(--radius)",  // 16px from spec
        '2xl': "1.5rem",
      },
      fontFamily: {
        sans: ['Inter', 'system-ui', 'sans-serif'],
        serif: ['Cinzel', 'Cormorant Garamond', 'serif'], // Fantasy headings
        mono: ['JetBrains Mono', 'monospace'],
      },
      boxShadow: {
        etched: "var(--shadow)", // canonical etched border shadow
      },
      backgroundImage: {
